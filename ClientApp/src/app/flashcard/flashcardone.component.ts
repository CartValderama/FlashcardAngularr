...
export class FlashcardoneComponent implements OnInit {
  ...
  async checkFlashcard(flashcard: IFlashcard) {
    ...
    const description = await this.createImageDescription(this.flashcard.Question);
  ...
  async createImageDescription(question: string) {
    ...
    const API_KEY = "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"; // PUT THE API KEY HERE
